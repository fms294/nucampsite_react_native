...
import {Text, View, Alert,ScrollView, StyleSheet, Picker, Switch, Button, Modal, Animated} from 'react-native';
    ...
    render(){
        return(
            <Animatable.View animation='zoomIn' duration={2000} delay={1000}>
                ...
                <View style={styles.formRow}> 
                    <Text style={styles.formLabel}>Hide-In?</Text>
                    <Switch  
                        style={styles.formItem}
                ...
                <View style={styles.formRow}>
                    <Button
                        ...
                        title='Search'
                        color='#5617DD'
                        accessibilityLabel='Tap me to search for available campsies to reserve'
                    />
                </View>        
            </Animatable.View>
        );
